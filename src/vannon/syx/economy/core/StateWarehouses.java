...
public final class StateWarehouses implements Saveable {
    ...
    private final HashSet<Long> owned = new HashSet<>();
    ...
    private static long key(RoomInstance room) {
    ...
    public void setLiquidating(RoomInstance warehouse, boolean value) {
        ...
        if (value) {
            this.liquidating.add(StateWarehouses.key(warehouse));
        } else {
            this.liquidating.remove(StateWarehouses.key(warehouse));
        }
    }

    public void toggleLiquidating(RoomInstance warehouse) {
        this.setLiquidating(warehouse, !this.isLiquidating(warehouse));
    }

    public void setAllLiquidating(boolean value) {
        if (value) {
            this.liquidating.addAll(this.owned);
        } else {
    ...
    public int buyPrice(RESOURCE resource) {
        this.ensureSized();
        return resource == null ? 0 : this.buyPrice[resource.index()];
    }
    ...
    public void setBuyPrice(RESOURCE resource, int price) {
        ...
        this.ensureSized();
        this.buyPrice[resource.index()] = StateWarehouses.clampPrice(price);
    }

    public int sellPrice(RESOURCE resource) {
        this.ensureSized();
        return resource == null ? 0 : this.sellPrice[resource.index()];
    }
    ...
    public void setSellPrice(RESOURCE resource, int price) {
        ...
        this.ensureSized();
        this.sellPrice[resource.index()] = StateWarehouses.clampPrice(price);
    }

    public int crownMarketPrice(RESOURCE resource) {
        this.ensureSized();
        return resource == null ? 75 : this.crownMarketPrice[resource.index()];
    }
    ...
    public void setCrownMarketPrice(RESOURCE resource, int price) {
        ...
        this.ensureSized();
        this.crownMarketPrice[resource.index()] = StateWarehouses.clampPrice(price);
    }
