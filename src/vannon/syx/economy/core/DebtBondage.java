...
public final class DebtBondage implements Saveable {
    ...
    public void update(Roster roster, Wallets wallets) {
        ...
        for (int i = 0; i < roster.size(); ++i) {
            ...
            if (!enslaveNow || debt < threshold || !(hum != null ? hum.isEnslaveablePleb(h) : EngineSeams.isEnslaveablePleb(h))) continue;
            if (hum != null) hum.enslave(h); else EngineSeams.enslave(h);
