...
public final class PropertyMarketController {
    ...
    public void update() {
        ...
        if (rooms != null && EconConfig.homePurchaseEnabled && SETT.ROOMS() != null) {
            settlement.room.home.house.ROOM_HOME homeRoom = rooms.getHome();
            ...
            settlement.room.home.chamber.ROOM_CHAMBER chamberRoom = rooms.getChamber();
            if (chamberRoom != null) {
        ...
        if (EconConfig.workplaceSharesEnabled) {
            if (rooms != null) ledger.accrueDividends(this.firmLedger, rooms.getRoomImps());
