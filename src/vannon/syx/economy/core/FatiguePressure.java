    ...
    public static void register() {
        ...
        BValue.BValueInduOnly pressure = new BValue.BValueInduOnly() {
            public double vGet(Induvidual indu) {
                ...
                if (EconConfig.wealthRestEnabled && sim.relativeWealth(indu) > EconConfig.wealthRestMedianMultiplier) {
                    threshold = (int)(threshold * EconConfig.wealthRestThresholdFactor);
                }
