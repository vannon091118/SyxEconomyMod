...
public final class EngineLevers {
    ...
    // ═══ ITreasuryAccess (A-05) ═════════════════════════════
    /** Master-Switch für alle Treasury-Zugriffe. */
    public static boolean treasuryAccessEnabled = true;

    // ─── Player Treasury ────────────────────────────────────
    public static boolean treasuryPlayerCreditsEnabled = true;
    public static boolean treasuryPlayerIncomeEnabled = true;
    public static boolean treasuryPlayerExpensesEnabled = true;
    public static boolean treasuryPlayerNetDailyEnabled = true;
    public static boolean treasuryPlayerHistoryEnabled = true;

    // ─── Taxation ───────────────────────────────────────────
    public static boolean treasuryTaxRatesReadEnabled = true;
    public static boolean treasuryTaxRatesWriteEnabled = true;
    public static boolean treasuryTaxRevenueEnabled = true;

    // ─── Subsidies & Grain Dole ─────────────────────────────
    public static boolean treasurySubsidiesEnabled = true;
    public static boolean treasuryGrainDoleReadEnabled = true;
    public static boolean treasuryGrainDoleWriteEnabled = true;

    // ─── Crisis ─────────────────────────────────────────────
    public static boolean treasuryCrisisTierEnabled = true;
    public static boolean treasuryCrisisThresholdsEnabled = true;
    public static boolean treasuryHardFloorEnabled = true;

    // ─── NPC Treasuries ─────────────────────────────────────
    public static boolean treasuryNpcTreasuriesEnabled = true;

    // ─── Trade / World Price ────────────────────────────────
    public static boolean treasuryWorldPriceEnabled = true;

    // ═══ IPopulationAccess (A-06) ══════════════════════════
    /** Master-Switch für alle Population-Zugriffe. */
    public static boolean populationAccessEnabled = true;

    // ─── Totals ─────────────────────────────────────────────
    public static boolean popTotalsByClassEnabled = true;
    public static boolean popTotalsByRaceEnabled = true;
    public static boolean popIncomingEnabled = true;

    // ─── Loyalty / Standing ─────────────────────────────────
    public static boolean popLoyaltyEnabled = true;
    public static boolean popTargetLoyaltyEnabled = true;
    public static boolean popExpectationEnabled = true;

    // ─── Wealth / Wallet ────────────────────────────────────
    public static boolean popAvgWalletEnabled = true;
    public static boolean popMedianWalletEnabled = true;
    public static boolean popGiniEnabled = true;
    public static boolean popWealthBracketsEnabled = true;

    // ─── Employment ─────────────────────────────────────────
    public static boolean popEmployedEnabled = true;
    public static boolean popUnemployedEnabled = true;
    public static boolean popAvgWageEnabled = true;

    // ─── Housing ────────────────────────────────────────────
    public static boolean popHousingCapacityEnabled = true;
    public static boolean popHousingUsedEnabled = true;
    public static boolean popHousingFreeEnabled = true;
    public static boolean popHomelessEnabled = true;

    // ─── Demographics ───────────────────────────────────────
    public static boolean popAgeDistEnabled = true;
    public static boolean popAvgAgeEnabled = true;
    public static boolean popBirthRateEnabled = true;
    public static boolean popDeathRateEnabled = true;

    // ─── Needs / Happiness ──────────────────────────────────
    public static boolean popHappinessEnabled = true;
    public static boolean popNeedSatisfactionEnabled = true;

    // ─── Types (HTYPES) ─────────────────────────────────────
    public static boolean popTypesEnabled = true;

    // ═══ IGoodsAccess (A-07) ════════════════════════════════
    /** Master-Switch für alle Goods-Zugriffe. */
    public static boolean goodsAccessEnabled = true;

    // ─── Prices ─────────────────────────────────────────────
    public static boolean goodsWorldPriceEnabled = true;
    public static boolean goodsLocalPriceEnabled = true;
    public static boolean goodsAnchorPriceEnabled = true;
    public static boolean goodsScarcityMultiplierEnabled = true;
    public static boolean goodsEffectiveCoverageEnabled = true;
    public static boolean goodsPriceCapEnabled = true;

    // ─── Production / Consumption ───────────────────────────
    public static boolean goodsDailyProductionEnabled = true;
    public static boolean goodsDailyConsumptionEnabled = true;
    public static boolean goodsNetDailyFlowEnabled = true;
    public static boolean goodsProducerCountEnabled = true;
    public static boolean goodsConsumerCountEnabled = true;

    // ─── Stockpiles ─────────────────────────────────────────
    public static boolean goodsTotalStockpileEnabled = true;
    public static boolean goodsReservableStockpileEnabled = true;
    public static boolean goodsCrownStorageEnabled = true;
    public static boolean goodsPlayerStockpileEnabled = true;

    // ─── Import / Export ────────────────────────────────────
    public static boolean goodsImportingEnabled = true;
    public static boolean goodsExportingEnabled = true;
    public static boolean goodsImportLimitEnabled = true;
    public static boolean goodsExportLimitEnabled = true;
    public static boolean goodsImportedYesterdayEnabled = true;
    public static boolean goodsExportedYesterdayEnabled = true;
    public static boolean goodsImportPriceEnabled = true;
    public static boolean goodsExportPriceEnabled = true;

    // ─── FlowPrices Detail ──────────────────────────────────
    public static boolean goodsActiveTradablesEnabled = true;
    public static boolean goodsPriceHistoryEnabled = true;
    public static boolean goodsProductionHistoryEnabled = true;
    public static boolean goodsConsumptionHistoryEnabled = true;

    // ─── Trade Balance ──────────────────────────────────────
    public static boolean goodsPlayerCreditsEnabled = true;
    public static boolean goodsDailyTradeBalanceEnabled = true;
    public static boolean goodsCumulativeTradeBalanceEnabled = true;
    ...
    public static void dump() {
        ...
        logSubSystem("TreasuryAccess", treasuryAccessEnabled);
        logSubSystem("PopulationAccess", populationAccessEnabled);
        logSubSystem("GoodsAccess", goodsAccessEnabled);
    }
