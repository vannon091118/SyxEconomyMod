...
> **Version:** v0.13.101 | **Stand:** 2026-07-28
>
...
### IO-Analysis-Subsystem (ab v0.13.79)

**Zweck:** Empirische Input-Output-Analyse der Industrieverflechtungen. Bricht die
"Industrie-Blackbox" auf: Kein isolierter Preis pro Ressource mehr, sondern
Ketten-Effekte über die gesamte Produktionskette.

| Begriff | Definition |
|---|---|
| **IOGraph** | Logischer Rezeptgraph. Adjacency: RESOURCE → List<Industry> für Produzenten und Konsumenten. Gebaut aus `SETT.ROOMS().industries.all` nach Engine-Init. |
| **IOMatrix** | Empirische IO-Tabelle. Technische Koeffizienten-Matrix A[n×n] aus FlowMeter-Supply-Daten. Leontief-Inverse L=(I-A)⁻¹ via Gauß-Jordan. |
| **Technischer Koeffizient** | A[i][j] = wie viel Ressource i pro Einheit Ressource j verbraucht (direkt). |
