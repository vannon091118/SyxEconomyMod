...
| [`docs/ROADMAP.md`](docs/ROADMAP.md) | Development phases, milestones, backlog |
| [`docs/CHANGELOG.md`](docs/CHANGELOG.md) | Per-version changes |
| [`docs/GLOSSARY.md`](docs/GLOSSARY.md) | Terminology: economic concepts, SoS engine terms |
| [`docs/MASTER_AUDIT_PHASE5.md`](docs/MASTER_AUDIT_PHASE5.md) | 4-perspective audit: gaps, blockers, Phase 5 prep |
| [`docs/GAP_ANALYSIS_PHASE5.md`](docs/GAP_ANALYSIS_PHASE5.md) | Detailed gap analysis for Phase 5 |
| [`docs/BALANCE_LEVERS.md`](docs/BALANCE_LEVERS.md) | All tunable constants and their effects |
| [`docs/BACKLOG.md`](docs/BACKLOG.md) | Accumulated feature requests from live testing |
| [`docs/live-notes/`](docs/live-notes/) | Raw playtest observations (funnel into backlog weekly) |
| [`tools/vanilla-api-inventory.md`](tools/vanilla-api-inventory.md) | All vanilla hooks we COULD use, with recommendations |
...
using [the template](docs/live-notes/.template.md). Tag with one of:

- `cover:plan-task-N` — maps to existing plan task
- `gap:net-new` — new feature/gap
- `reject:scope-out` — acknowledged, out of scope
- `ux:papercut` — UI annoyance
- `balance:drift` — numbers feel wrong
- `bug:silent` — silent data loss/corruption (P0)
...
- **4-Perspective Audit system:** Self-audit methodology for solo-dev quality assurance
